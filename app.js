...
function greeting(){const h=new Date().getHours();const g=LANG==='en'?['Good evening','Good morning','Good afternoon','Good evening']:['Natë të mbarë','Mirëmëngjes','Mirëdita','Mirëmbrëma'];return h<5?g[0]:h<12?g[1]:h<18?g[2]:g[3];}

/* ---------- i18n (SQ / EN) ---------- */
let LANG = LS.get('lang','sq');
...
const I18N = {
  sq:{
    ...
    ob1_t:'Mbaj çdo dokument të rëndësishëm në një vend.', ob1_p:'Identiteti, arsimi, puna, automjeti, shëndeti — të gjitha të organizuara, gjithmonë me ty.',
    ob2_t:'Sistemi i lexon dokumentet automatikisht.', ob2_p:'Fotografo një dokument dhe OCR-ja njeh tekstin, datat dhe institucionin brenda sekondash.',
    ob3_t:'Identiteti yt mbrohet me sigurinë më moderne.', ob3_p:'Enkriptim AES-256, Face ID dhe QR verifikim. Dokumentet nuk largohen kurrë pa lejen tënde.',
    su_create:'Krijo llogarinë', su_sub:'Ndërto identitetin tënd digjital në pak hapa.',
    su_identity:'Identiteti', su_contact:'Kontakti', su_security:'Siguria',
    su_name:'Emri dhe mbiemri', su_name_ph:'p.sh. Arion Krasniqi', su_region:'Vendi / rajoni', su_lang:'Gjuha',
    su_email:'Adresa e email-it', su_email_ph:'emri@shembull.com', su_phone:'Numri i telefonit', su_opt:'opsional',
    su_continue:'Vazhdo', su_back:'Prapa', su_to_security:'Vazhdo te siguria',
    su_consent:'Pranoj që të dhënat ruhen të enkriptuara lokalisht.', su_secure:'Enkriptim AES-256 · Asnjë e dhënë nuk del nga pajisja',
    su_preview:'Identiteti yt digjital', su_yourname:'Emri yt', su_member:'Anëtar që nga',
    err_name:'Shkruaj emrin dhe mbiemrin', err_email:'Email jo i vlefshëm', err_consent:'Prano kushtet për të vazhduar',
    pin_create:'Krijo PIN-in tënd', pin_confirm:'Konfirmo PIN-in', pin_hint:'4 shifra për të mbrojtur vault-in tënd digjital.', pin_hint2:'Shkruaj sërish për ta konfirmuar.',
    bio_title:'Aktivizo Face ID / Touch ID', bio_desc:'Përdor identitetin biometrik të pajisjes për ta hapur vault-in menjëherë dhe në mënyrë të sigurt.',
    bio_enable:'Aktivizo biometrikën', bio_later:'Jo tani — përdor vetëm PIN-in',
    welcome_back:'Mirë se erdhe përsëri', unlock_bio:'Përdor Face ID ose shkruaj PIN-in', unlock_pin:'Shkruaj PIN-in',
    lang_name:'Shqip'
  },
  en:{
    ob_skip:'Skip', ob_next:'Continue', ob_start:'Get started',
    ob1_t:'Keep every important document in one place.', ob1_p:'Identity, education, work, vehicle, health — all organised, always with you.',
    ob2_t:'The system reads your documents automatically.', ob2_p:'Snap a document and OCR extracts the text, dates and issuer within seconds.',
    ob3_t:'Your identity is protected by modern security.', ob3_p:'AES-256 encryption, Face ID and QR verification. Documents never leave without your permission.',
    su_create:'Create account', su_sub:'Build your digital identity in a few steps.',
    su_identity:'Identity', su_contact:'Contact', su_security:'Security',
    su_name:'Full name', su_name_ph:'e.g. Arion Krasniqi', su_region:'Country / region', su_lang:'Language',
    su_email:'Email address', su_email_ph:'name@example.com', su_phone:'Phone number', su_opt:'optional',
    su_continue:'Continue', su_back:'Back', su_to_security:'Continue to security',
    su_consent:'I agree my data is stored encrypted locally.', su_secure:'AES-256 encryption · No data leaves your device',
    su_preview:'Your digital identity', su_yourname:'Your name', su_member:'Member since',
    err_name:'Enter your full name', err_email:'Invalid email', err_consent:'Accept the terms to continue',
    pin_create:'Create your PIN', pin_confirm:'Confirm your PIN', pin_hint:'4 digits to protect your digital vault.', pin_hint2:'Enter it again to confirm.',
    bio_title:'Enable Face ID / Touch ID', bio_desc:'Use your device biometrics to open the vault instantly and securely.',
    bio_enable:'Enable biometrics', bio_later:'Not now — use PIN only',
    welcome_back:'Welcome back', unlock_bio:'Use Face ID or enter your PIN', unlock_pin:'Enter your PIN',
    lang_name:'English'
  }
};
function tr(k){ const d=I18N[LANG]||I18N.sq; return (k in d)?d[k]:(I18N.sq[k]||k); }
function regionLabel(r){ return LANG==='en' ? (REGIONS_EN[r]||r) : r; }
function setLang(l){ LANG=l; LS.set('lang',l); }
